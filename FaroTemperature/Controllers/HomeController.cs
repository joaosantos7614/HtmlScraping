...
namespace FaroTemperature.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            string urlToScrape = "https://pt.allmetsat.com/metar-taf/portugal-espanha.php?icao=LPPT";
            ...
            Match match = Regex.Match(innerHtml, @"Temperatura <b>(\S*)</b>", RegexOptions.IgnoreCase | RegexOptions.Multiline);
